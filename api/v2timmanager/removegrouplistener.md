...
| 参数名称     | 参数类型                                                                  | 是否必填 | 描述         |
| -------- | --------------------------------------------------------------------- | ---- | ---------- |
| listener | [V2TimGroupListener](../keyClass/listener/v2timgrouplistener.md) | 是    | 需要移除的群组监听器 |
...
```dart
    ...
    //添加成功之后可移除群组监听器
    TencentImSDKPlugin.v2TIMManager.removeGroupListener(listener: listener);//需要移除的群组监听器
```
