...
| 参数名称        | 参数类型                                                              | 是否必填 | 描述     |
| ----------- | ----------------------------------------------------------------- | ---- | ------ |
| searchParam | [V2TimMessageSearchParam](../../class/v2timmessagesearchparam.md) | 是    | 搜索设置参数 |
...
| desc | String                                                              | 请求结果描述                                                         |
| data | [V2TimMessageSearchResult](../../class/v2timmessagesearchresult.md) | 符合搜索条件的所有信息                                                    |
