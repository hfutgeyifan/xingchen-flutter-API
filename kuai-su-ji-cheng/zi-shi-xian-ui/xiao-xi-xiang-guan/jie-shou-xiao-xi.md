...
接收到地理位置消息后，接收放可直接从 [`locationElem`](../../../api/guan-jian-lei/message/v2timlocationelem.md) 中解析出经纬度信息。
...
SDK 仅为表情消息提供消息透传的通道，消息内容字段参考 [`faceElem`](../../../api/guan-jian-lei/message/v2timfaceelem.md) 定义。其中 `index` 和 `data` 的内容由客户自定义。
...
1. 解析出 [`V2TIMGroupTipsElem`](../../../api/guan-jian-lei/group/v2timgrouptipselem.md) 中的各个字段
