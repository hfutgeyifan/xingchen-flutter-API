...
TUIKit 是基于腾讯云 IM SDK 的一款 UI 组件库，它提供了一些通用的 UI 组件，例如会话列表、聊天界面和联系人列表等，开发者可根据实际业务需求通过该组件库快速地搭建自定义 IM 应用。参见 [TUIKit 详细介绍](../xingchen-flutter-API/kuai-su-ji-cheng/tuikit/kuai-su-ji-cheng-fang-an.md)。
...
如您需要用到推送能力，还需要添加推送相关权限，详情可查看 [Flutter 厂商消息推送插件集成指南](../xingchen-flutter-API/kuai-su-ji-cheng/zi-shi-xian-ui/li-xian-tui-song.md)。
{% endhint %}
...
[本节详细文档](kuai-su-ji-cheng/zi-shi-xian-ui/ji-cheng-sdk.md)
...
[本节详细文档](kuai-su-ji-cheng/zi-shi-xian-ui/chu-shi-hua.md)
...
[本节详细文档](kuai-su-ji-cheng/zi-shi-xian-ui/deng-lu-deng-chu.md)
...
[本节详细文档](kuai-su-ji-cheng/zi-shi-xian-ui/xiao-xi-xiang-guan/fa-song-xiao-xi.md)
...
[本节详细文档](kuai-su-ji-cheng/zi-shi-xian-ui/xiao-xi-xiang-guan/jie-shou-xiao-xi.md)
...
您可以继续完成 [群组](kuai-su-ji-cheng/zi-shi-xian-ui/qun-zu-xiang-guan/qun-zu-jie-shao.md)，[用户资料](kuai-su-ji-cheng/zi-shi-xian-ui/yong-hu-guan-li/yong-hu-zi-liao.md)，[关系链](kuai-su-ji-cheng/zi-shi-xian-ui/yong-hu-guan-li/hao-you-guan-li.md)，[离线推送](kuai-su-ji-cheng/zi-shi-xian-ui/yong-hu-guan-li/yong-hu-zi-liao.md)，[关系链](kuai-su-ji-cheng/zi-shi-xian-ui/li-xian-tui-song.md)，[本地搜索](kuai-su-ji-cheng/zi-shi-xian-ui/ben-di-sou-suo/sou-suo-xiao-xi.md) 等相关功能开发。

详情可查看 [自实现 UI 集成 SDK 文档](kuai-su-ji-cheng/zi-shi-xian-ui/README.md)。

## 常见问题

### 支持哪些平台？
- 目前 [IM SDK(tencent_im_sdk_plugin)](kuai-su-ji-cheng/zi-shi-xian-ui/ji-cheng-sdk.md) 支持 iOS 、Android 和 Web 三个平台，此外 Windows 和 Mac 版正在开发中，敬请期待。
- [TUIKit](kuai-su-ji-cheng/tuikit/README.md) 及 [配套完整版交互 Demo](https://github.com/TencentCloud/TIMSDK/tree/master/Flutter/Demo/im-flutter-uikit) 支持 iOS 及 Android 两个移动平台。
