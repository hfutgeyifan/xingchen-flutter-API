...
根据 [`searchGroupMembers`](../../../api/v2timgroupmanager/searchgroupmembers.md) 入参 [`V2TIMGroupMemberSearchParam`](../../../api/keyClass/group/v2timgroupmembersearchparam.md)中的 `groupIDList` 是否为空（`null`/`nil`），分为两种情况：
