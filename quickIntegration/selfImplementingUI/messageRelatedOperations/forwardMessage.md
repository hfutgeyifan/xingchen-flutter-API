...
#### 解析消息
添加监听器后，接收方会在 [`onRecvNewMessage`](../../../api/callbacks/onrecvnewmessagecallback.md) 中收到合并消息 [`V2TimMessage`](../../../api/keyClass/message/v2timmessage.md)。
可以先通过合并消息元素 [`V2TimMergerElem`](../../../api/keyClass/message/v2timmergerelem.md) 获取 `title` 和  `abstractList`  UI 展示。
